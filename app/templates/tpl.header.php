...
<header>
    <div>
        <ul id="full_menu">
            ...
            <li><a class="header_menu_a" href="<?= Config::getSiteURL() ?>photostream"><?php LangPak::getWord('Photostream') ?></a></li>
            <li><a class="header_menu_a" href="<?= Config::getSiteURL() ?>search"><?php LangPak::getWord('Search') ?></a></li>
            <li><a class="header_menu_a" href="<?= Config::getSiteURL() ?>about"><?php LangPak::getWord('About') ?></a></li>
